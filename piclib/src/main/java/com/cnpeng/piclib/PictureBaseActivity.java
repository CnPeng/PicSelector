...
import com.cnpeng.piclib.compress.Luban;
import com.cnpeng.piclib.compress.OnCompressListener;
...
import com.cnpeng.piclib.immersive.ImmersiveManage;
...
public class PictureBaseActivity extends FragmentActivity {
    ...
    protected void startCrop(String originalPath) {
        ...
        optionBundle.putBoolean(EXTRA_SCALE, config.scaleEnabled);
        optionBundle.putBoolean(EXTRA_ROTATE, config.rotateEnabled);
        //是否可拖动裁剪框
        optionBundle.putBoolean(EXTRA_DRAG_CROP_FRAME, config.isDragFrame);
